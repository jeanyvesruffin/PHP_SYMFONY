...
> Le composant HttpKernel fournit un processus structuré pour convertir un Requesten un Responseen utilisant le composant EventDispatcher. Il est suffisamment flexible pour créer un framework full-stack (Symfony), un micro-framework (Silex) ou un système CMS avancé (Drupal).
